...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v5.12.1/tdesktop-5.12.1-full.tar.gz -> tdesktop-5.12.1-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v5.12.1/tsetup.5.12.1.tar.xz -> tsetup.5.12.1.tar.xz"
