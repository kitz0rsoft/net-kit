...
SRC_URI="
	amd64? ( https://dl.grafana.com/oss/release/grafana-11.4.1.linux-amd64.tar.gz -> grafana-11.4.1.linux-amd64.tar.gz )
	arm64? ( https://dl.grafana.com/oss/release/grafana-11.4.1.linux-arm64.tar.gz -> grafana-11.4.1.linux-arm64.tar.gz )
"
